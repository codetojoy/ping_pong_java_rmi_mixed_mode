...
import net.codetojoy.client.PongServiceModernClient;
...
class Task implements Runnable {
    ...
    private static final String PONG_SERVICE = "pongServiceEndpoint";
...
public class Monitor {
    ...
    public static void main(String[] args) {
        try {
            ...
            PongService pongService = new PongServiceModernClient().getPongService();
